...
func (c *metricsServiceClient) GetAllGauges(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (MetricsService_GetAllGaugesClient, error) {
	stream, err := c.cc.NewStream(grpc.NewContextWithServiceInfo(ctx, &_MetricsService_serviceInfo), &_MetricsService_serviceDesc.Streams[0], "/grpc.testing.MetricsService/GetAllGauges", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *metricsServiceClient) GetGauge(ctx context.Context, in *GaugeRequest, opts ...grpc.CallOption) (*GaugeResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_MetricsService_serviceInfo), "/grpc.testing.MetricsService/GetGauge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _MetricsService_serviceInfo = grpc.ServiceInfoForDesc(&_MetricsService_serviceDesc)
