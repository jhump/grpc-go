...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Greeter_serviceInfo), "/helloworld.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Greeter_serviceInfo = grpc.ServiceInfoForDesc(&_Greeter_serviceDesc)
