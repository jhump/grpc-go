...
func (c *searchServiceClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_SearchService_serviceInfo), "/grpc.testing.SearchService/Search", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *searchServiceClient) StreamingSearch(ctx context.Context, opts ...grpc.CallOption) (SearchService_StreamingSearchClient, error) {
	stream, err := c.cc.NewStream(grpc.NewContextWithServiceInfo(ctx, &_SearchService_serviceInfo), &_SearchService_serviceDesc.Streams[0], "/grpc.testing.SearchService/StreamingSearch", opts...)
	if err != nil {
		return nil, err
	}
...
var _SearchService_serviceInfo = grpc.ServiceInfoForDesc(&_SearchService_serviceDesc)
