...
func (c *healthClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Health_serviceInfo), "/grpc.health.v1.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthClient) Watch(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (Health_WatchClient, error) {
	stream, err := c.cc.NewStream(grpc.NewContextWithServiceInfo(ctx, &_Health_serviceInfo), &_Health_serviceDesc.Streams[0], "/grpc.health.v1.Health/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
var _Health_serviceInfo = grpc.ServiceInfoForDesc(&_Health_serviceDesc)
