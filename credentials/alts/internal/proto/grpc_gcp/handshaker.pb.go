...
func (c *handshakerServiceClient) DoHandshake(ctx context.Context, opts ...grpc.CallOption) (HandshakerService_DoHandshakeClient, error) {
	stream, err := c.cc.NewStream(grpc.NewContextWithServiceInfo(ctx, &_HandshakerService_serviceInfo), &_HandshakerService_serviceDesc.Streams[0], "/grpc.gcp.HandshakerService/DoHandshake", opts...)
	if err != nil {
		return nil, err
	}
...
var _HandshakerService_serviceInfo = grpc.ServiceInfoForDesc(&_HandshakerService_serviceDesc)
