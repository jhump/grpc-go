...
func (c *loadBalancerClient) BalanceLoad(ctx context.Context, opts ...grpc.CallOption) (LoadBalancer_BalanceLoadClient, error) {
	stream, err := c.cc.NewStream(grpc.NewContextWithServiceInfo(ctx, &_LoadBalancer_serviceInfo), &_LoadBalancer_serviceDesc.Streams[0], "/grpc.lb.v1.LoadBalancer/BalanceLoad", opts...)
	if err != nil {
		return nil, err
	}
...
var _LoadBalancer_serviceInfo = grpc.ServiceInfoForDesc(&_LoadBalancer_serviceDesc)
