...
func (c *channelzClient) GetTopChannels(ctx context.Context, in *GetTopChannelsRequest, opts ...grpc.CallOption) (*GetTopChannelsResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Channelz_serviceInfo), "/grpc.channelz.v1.Channelz/GetTopChannels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelzClient) GetServers(ctx context.Context, in *GetServersRequest, opts ...grpc.CallOption) (*GetServersResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Channelz_serviceInfo), "/grpc.channelz.v1.Channelz/GetServers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelzClient) GetServer(ctx context.Context, in *GetServerRequest, opts ...grpc.CallOption) (*GetServerResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Channelz_serviceInfo), "/grpc.channelz.v1.Channelz/GetServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelzClient) GetServerSockets(ctx context.Context, in *GetServerSocketsRequest, opts ...grpc.CallOption) (*GetServerSocketsResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Channelz_serviceInfo), "/grpc.channelz.v1.Channelz/GetServerSockets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelzClient) GetChannel(ctx context.Context, in *GetChannelRequest, opts ...grpc.CallOption) (*GetChannelResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Channelz_serviceInfo), "/grpc.channelz.v1.Channelz/GetChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelzClient) GetSubchannel(ctx context.Context, in *GetSubchannelRequest, opts ...grpc.CallOption) (*GetSubchannelResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Channelz_serviceInfo), "/grpc.channelz.v1.Channelz/GetSubchannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelzClient) GetSocket(ctx context.Context, in *GetSocketRequest, opts ...grpc.CallOption) (*GetSocketResponse, error) {
	...
	err := c.cc.Invoke(grpc.NewContextWithServiceInfo(ctx, &_Channelz_serviceInfo), "/grpc.channelz.v1.Channelz/GetSocket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Channelz_serviceInfo = grpc.ServiceInfoForDesc(&_Channelz_serviceDesc)
